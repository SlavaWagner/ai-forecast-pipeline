...
function showAgyPrerequisiteWarning(attemptedCmd) {
  const purpleBox = chalk.hex('#a855f7');
  ...
  console.log(purpleBox('⚠️   VORBEDINGUNG ERFORDERLICH: GOOGLE ANTIGRAVITY CLI ("agy")'));
  console.log(purpleBox('================================================================================'));
  console.log();
  console.log(whiteBold('  Die AI Forecast Pipeline funktioniert ausschließlich'));
  ...
  console.log(chalk.yellow('  kannst du mit den Befehlen der ai-forecast-pipeline chatten und die'));
  console.log(chalk.yellow('  ETS-Forecasting- und Budget-Simulations-Workflows bedienen.'));
  console.log();
  ...
  console.log(whiteBold('     In Antigravity kannst du interaktiv mit den Forecasting-Agenten'));
  console.log(whiteBold('     chatten und sämtliche ETS- und Budget-Scaling-Szenarien steuern.'));
  console.log();
  console.log(purpleBox('================================================================================'));
...
program
  ...
  .description('Google Ads AI Forecasting & Budget Simulation CLI (requires Antigravity CLI)')
  .version('1.0.0');
...
async function showInteractiveDashboard() {
  ...
  const choice = await select({
    ...
    choices: [
      ...
      { name: '3. Chat with an AI Agent (chat)', value: 'chat' },
      { name: '4. Setup Google Ads API Connection (setup)', value: 'setup' },
      { name: '5. List Registered AI Agents', value: 'list-agents' },
